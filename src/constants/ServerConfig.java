...
public class ServerConfig {
    ...
    public static boolean logAccounts = true; //Writes to a loose file called Account, unhashed.
    public static final int flags = 3;
    public static final String serverName = "ZenMS v144.3";
    public static final String eventMessage = "~ ZenMS v144.3 Open Beta! ~";
    ...
    public static final String scrollingMessage = "~ ZenMS v144.3 Open Beta. Nªu b¢n g¶p b¬t cñ v¬n «¹ g¾, vui lÆng liên h½ bÎn m¾nh t¢i fanpage ho¶c forum nhé! ~";    public static final int userLimit = 1500;
    ...
    public static final int EXP = 5; //exp rate (only works when fixedRates = true)
    ...
    public static final int CASH_DROP_RATE = 5; //out of 100
